            ...
            <TabGroup>
                ...
                <TabPanels>
                                ...
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            ...
                                            <input id="username" type="text" placeholder="Jim" class="form-input" />
                                        </div>
                    ...
                    <TabPanel>
                        <div>
                            <form class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-[#0e1726]">
                                <h6 class="text-lg font-bold mb-5">General Infasasasormation</h6>
                                <div class="flex flex-col sm:flex-row">
                                    <div class="ltr:sm:mr-4 rtl:sm:ml-4 w-full sm:w-2/12 mb-5">
                                        <img src="/assets//images/profile-34.jpeg" alt="" class="w-20 h-20 md:w-32 md:h-32 rounded-full object-cover mx-auto" />
                                    </div>
...
<script lang="ts" setup>
    ...
    try {
        ...
        const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzMwODg4MjAxLCJpYXQiOjE3MTUzMzYyMDEsImp0aSI6ImNlMjAzYzU2ZGQ4MDQxZDlhMTQ3ZWIwODhhOWVkOTA1IiwidXNlcl9pZCI6MzEsInVzZXJuYW1lIjoic3BpX3BhcGEiLCJlbWFpbCI6InBhcGFkb3BvdWxvc0BleGFtcGxlLmNvbSJ9.B6jh84YZRahN9WuCUgLoZ8Hx387JOTGdfl57lR874_o'
